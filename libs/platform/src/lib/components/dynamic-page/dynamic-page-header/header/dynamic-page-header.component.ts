            ...
            switch (background) {
                case 'transparent':
                    this._addClassNameToCustomElement(
                        ...
                        CLASS_NAME.dynamicPageHeaderTransparentBg
                    );
                    break;
                case 'list':
                case 'solid':
        ...
        if (this.headerContent) {
            switch (sizeType) {
                case 'small':
                    this._addClassNameToCustomElement(
                        this.headerContent.nativeElement,
                        CLASS_NAME.dynamicPageHeaderSmall
                    );
                    break;
                case 'medium':
                    this._addClassNameToCustomElement(
                        this.headerContent.nativeElement,
                        CLASS_NAME.dynamicPageHeaderMedium
                    );
                ...
                case 'large':
                    this._addClassNameToCustomElement(
                        this.headerContent.nativeElement,
                        CLASS_NAME.dynamicPageHeaderLarge
                    );
                ...
                default:
                    this._addClassNameToCustomElement(
                        this.headerContent.nativeElement,
                        CLASS_NAME.dynamicPageHeaderExtraLarge
                    );
                    break;
            }
        }
