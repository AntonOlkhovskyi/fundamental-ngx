...
describe('DynamicPageHeaderComponent', () => {
    ...
    it('Should not be able to see expand/collapse or pin button if collapsible is "false"', async () => {
        let expandCollapseButton = fixture.debugElement.queryAll(
            By.css('.fd-dynamic-page__header-visibility-container--button-group')
        );
    ...
    describe('expand actions', async () => {
        it('should be able to expand the header', async () => {
            ...
            await wait(fixture);
            const contentEl = fixture.debugElement.queryAll(By.css('.fd-dynamic-page__header'));
    ...
    describe('collapse actions', async () => {
        it('should be able to collapse the header', async () => {
            ...
            fixture.detectChanges();
            const contentEl: HTMLElement = fixture.debugElement.query(By.css('.fd-dynamic-page__header')).nativeElement;
    ...
    describe('page header area', () => {
        it('should set size', async () => {
            const headerElement = fixture.debugElement.query(By.css('.fd-dynamic-page__header'));
            expect(headerElement.nativeElement.classList.contains('fd-dynamic-page__header--md')).toBeTruthy();
            component.size = 'large';
            fixture.detectChanges();
            expect(headerElement.nativeElement.classList.contains('fd-dynamic-page__header--lg')).toBeTruthy();
            component.size = 'small';
            fixture.detectChanges();
            expect(headerElement.nativeElement.classList.contains('fd-dynamic-page__header--sm')).toBeTruthy();
        });
        it('should set background styles', async () => {
            ...
            fixture.detectChanges();
            expect(
                headerElement.nativeElement.classList.contains('fd-dynamic-page__header--transparent-bg')
            ).toBeTruthy();
